...
def train(task: str, method: str, fold: int, head_size: int):
    ...
    match task:
        ...
        case "sarcoma_t2_grading_binary":
            data = [file for file in glob(f"/home/johannes/Data/SSD_1.9TB/MultiViewGCN/data/sarcoma/*/T2/*{method}*.pt")]
        ...
        case "glioma_t1c_grading_binary":
            data = [file for file in glob(f"/home/johannes/Data/SSD_1.9TB/MultiViewGCN/data/ucsf/glioma_four_sequences/*T1c*{method}*.pt")]
        ...
        case "headneck_ct_hpv_binary":
            data = [file for file in glob(f"/home/johannes/Data/SSD_1.9TB/MultiViewGCN/data/headneck/converted_nii_merged/*/*{method}*.pt")]
