...
class I3DenseNet(torch.nn.Module):
    def __init__(self, densenet2d, frame_nb, inflate_block_convs=False, num_classes=2):
        ...
        #                                          self.final_time_dim)
        self.classifier = torch.nn.Linear(densenet2d.classifier.in_features, num_classes)

        self.pool = torch.nn.AdaptiveAvgPool3d(output_size=1)
